...
const config: GatsbyConfig = {
  siteMetadata: {
    ...
    siteTitle: `Eric Cross`,
    siteTitleAlt: `Eric Cross`,
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        name: `Eric Cross - Journeyman @ Woodcock Refrigeration`,
        short_name: `Eric Cross`,
        description: `Eric Cross - Journeyman @ Woodcock Refrigeration`,
        start_url: `/`,
